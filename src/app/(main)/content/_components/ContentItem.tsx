...
import { type contentItemsMock } from "./mocks/contentItems";
...
const ContentItem = ({ type, title, publishedAt, platforms }: ContentItemProps) => {
  ...
  return (
    <article className="w-full p-4 flex flex-col gap-[10px] rounded-[12px] bg-white shadow-drop cursor-pointer">
