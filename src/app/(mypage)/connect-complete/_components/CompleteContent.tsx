...
export const CompleteContent = () => {
  ...
  const currentAccount = accounts.find(acc => acc.snsType === platformToSnsType[currentPlatform]);
  ...
  return (
    <section className="pt-[194px] flex flex-col gap-5 items-center justify-center">
      <div className="flex flex-col items-center gap-1">
        ...
        <p className="italic text-blue-700 text-b2M creato-500">@{currentAccount.accountName}</p>
      </div>
