...
export const ViewVerticalIcon = ({
  ...
  <svg
    ...
    className={className}
    {...props}>
    <g clipPath="url(#clip0_1814_9617)">
      <path
...
export const ViewGalleryIcon = ({
  ...
  <svg
    ...
    className={className}
    {...props}>
    <g clipPath="url(#clip0_1814_9621)">
      <path
